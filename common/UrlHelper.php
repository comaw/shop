...
class UrlHelper extends Url
{
    ...
    public static function translateUrl($str){
        ...
        $to = "a b v g d e jo zh z i j k l m n o p r s t u f h c ch sh shh i y i ie iu ia A B V G D E Jo Zh Z I J K L M N O P R S T U F H C Ch Sh Shh II Y II IE IU IA _ _ _ _ _ _ _ _ - -";
        $go = explode(" ", $go);
        $to = explode(" ", $to);
